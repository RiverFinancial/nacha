defmodule Nacha.FileTest do
  ...
  @entries [
    %Entry{record: %EntryDetail{
      ...
      trace_id: "12345678", trace_number: 1}},
    %Entry{record: %EntryDetail{
