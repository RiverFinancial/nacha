defmodule Nacha.Records.BatchHeaderTest do
  ...
  @sample_record %Header{
    ...
    company_name: "My Best Comp.",
    discretionary_data: "Includes overtime",
    company_id: "1419871234",
    standard_entry_class: "PPD",
    entry_description: "Payroll",
    effective_date: ~D[2006-02-05],
    odfi_id: "09991234",
    batch_number: 1
  }
  @sample_string "5200My Best Comp.   Includes overtime   1419871234PPDPayroll         060205   1099912340000001"
