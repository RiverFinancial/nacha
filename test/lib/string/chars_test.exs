defmodule String.CharsTest do
  ...
  alias Nacha.Records.{
    Addendum, EntryDetail, BatchHeader, BatchControl, FileHeader, FileControl}

  @sample_entry %Entry{record: %EntryDetail{
  ...
  test "String.Chars implementation for NACHA records" do
    for mod <- [EntryDetail, Addendum, BatchHeader, BatchControl, FileHeader,
                FileControl] do
      record = struct(mod)
